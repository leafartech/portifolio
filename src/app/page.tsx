...
export default function Home() {
  ...
  return (
    <div>
      <header id="inicio" className="relative sm:min-h-screen flex justify-center overflow-hidden">
        <Navbar />
        <img src="./images/bg.png" alt="" className="absolute top-0 max-w-full" />
        <div className="w-full sm:max-w-7xl pt-16 sm:pt-28 z-40 flex flex-col items-center">
          ...
          <div className="w-full flex flex-col justify-center items-center flex-wrap gap-2 text-center">
            ...
            <h1 className="text-2xl sm:text-5xl grad-text font-extrabold tracking-in-expand">RAFAEL BORGES BEZERRA</h1>
            <p className={`highlited-text fade-in`}>Acompanhe minha jornada no mundo da programação 👇</p>
          </div>

          <div className="hidden sm:flex justify-center items-center flex-col sm:flex-row gap-6 mt-24 sm:w-[900px]">
          ...
          <div className="max-w-5xl mt-24 hidden sm:flex justify-center gap-4 flex-wrap">
            <Card
              imagePath="1"
              type=""
      ...
      <main className="flex flex-col-reverse sm:flex-col ">
